...
public class FragmentArticleDetailsBindingImpl extends FragmentArticleDetailsBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.articleDetailViewModel == variableId) {
            setArticleDetailViewModel((com.nytimes.android.viewmodel.ArticleDetailsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setArticleDetailViewModel(@Nullable com.nytimes.android.viewmodel.ArticleDetailsViewModel ArticleDetailViewModel) {
